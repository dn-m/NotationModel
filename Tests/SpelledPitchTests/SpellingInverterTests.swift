...
class SpellingInverterTests: XCTestCase {
    ...
    func testSpellingInverterPitchClass0() {
        ...
        XCTAssertTrue(spellingInverterNeutral.flowNetwork.contains((1,.up),.up))
        XCTAssertTrue(spellingInverterNeutral.flowNetwork.contains((1,.down),.down))
        XCTAssertTrue(spellingInverterUp.flowNetwork.contains((1,.up),.up))
        XCTAssertTrue(spellingInverterUp.flowNetwork.contains((1,.down),.up))
        XCTAssertTrue(spellingInverterDown.flowNetwork.contains((1,.up),.down))
        XCTAssertTrue(spellingInverterDown.flowNetwork.contains((1,.down),.down))
    }
    ...
    func testSpellingInverterPitchClass8() {
        ...
        XCTAssertTrue(spellingInverterDown.flowNetwork.contains((1,.up),.down))
        XCTAssertTrue(spellingInverterDown.flowNetwork.contains((1,.down),.up))
        XCTAssertTrue(spellingInverterUp.flowNetwork.contains((1,.up),.up))
        XCTAssertTrue(spellingInverterUp.flowNetwork.contains((1,.down),.up))
    }
