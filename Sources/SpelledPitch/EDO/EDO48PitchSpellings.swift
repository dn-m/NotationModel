...
extension EDO48 {
    ...
    private static let spellingsByPitchClass: [Pitch.Class: [Pitch.Spelling<EDO48>]] = [
        ...
        00.00: [
            ...
            Pitch.Spelling(.d, .flat(count: 1))
        ],

        00.25: [
            Pitch.Spelling(.c, .natural, .up),
            Pitch.Spelling(.c, .quarter, .sharp(count: 1), .down),
            Pitch.Spelling(.d, .threeQuarter, .flat(count: 1), .down)
        ],

        00.50: [
            Pitch.Spelling(.c, .quarter, .sharp(count: 1)),
            Pitch.Spelling(.d, .threeQuarter, .flat(count: 1))
        ],

        00.75: [
            Pitch.Spelling(.c, .sharp(count: 1), .down),
            Pitch.Spelling(.d, .flat(count: 1), .down),
            Pitch.Spelling(.c, .quarter, .sharp(count: 1), .up),
            Pitch.Spelling(.d, .threeQuarter, .flat(count: 1), .up)
        ],
        ...
        01.25: [
            ...
            Pitch.Spelling(.d, .flat(count: 1), .up),
            Pitch.Spelling(.d, .quarter, .flat(count: 1), .down),
            Pitch.Spelling(.c, .threeQuarter, .sharp(count: 1), .down)
        ],

        01.50: [
            Pitch.Spelling(.d, .quarter, .flat(count: 1)),
            Pitch.Spelling(.c, .threeQuarter, .sharp(count: 1))
        ],

        01.75: [
            Pitch.Spelling(.d, .natural, .down),
            Pitch.Spelling(.d, .quarter, .flat(count: 1), .up)
        ],

        02.00: [
            Pitch.Spelling(.d),
            Pitch.Spelling(.c, .sharp(count: 2)),
            Pitch.Spelling(.e, .flat(count: 1))
        ],

        02.25: [
            Pitch.Spelling(.d, .natural, .up),
            Pitch.Spelling(.d, .quarter, .sharp(count: 1), .down),
            Pitch.Spelling(.e, .threeQuarter, .flat(count: 1), .down)
        ],

        02.50: [
            Pitch.Spelling(.d, .quarter, .sharp(count: 1)),
            Pitch.Spelling(.e, .threeQuarter, .flat(count: 1))
        ],

        02.75: [
            Pitch.Spelling(.e, .flat(count: 1), .down),
            Pitch.Spelling(.d, .sharp(count: 1), .down),
            Pitch.Spelling(.d, .quarter, .sharp(count: 1), .up),
            Pitch.Spelling(.e, .threeQuarter, .flat(count: 1), .up)
        ],

        03.00: [
            Pitch.Spelling(.e, .flat(count: 1)),
            Pitch.Spelling(.d, .sharp(count: 1)),
            Pitch.Spelling(.f, .flat(count: 1))
        ],

        03.25: [
            Pitch.Spelling(.e, .flat(count: 1), .up),
            Pitch.Spelling(.d, .sharp(count: 1), .up),
            Pitch.Spelling(.e, .quarter, .flat(count: 1), .down),
            Pitch.Spelling(.d, .threeQuarter, .sharp(count: 1), .down)
        ],

        03.50: [
            Pitch.Spelling(.e, .quarter, .flat(count: 1)),
            Pitch.Spelling(.d, .threeQuarter, .sharp(count: 1))
        ],

        03.75: [
            Pitch.Spelling(.e, .natural, .down),
            Pitch.Spelling(.e, .quarter, .flat(count: 1), .up),
        ...
        06.25: [
            ...
            Pitch.Spelling(.g, .flat(count: 1), .up),
            Pitch.Spelling(.g, .quarter, .flat(count: 1), .down),
            Pitch.Spelling(.f, .threeQuarter, .sharp(count: 1), .down)
        ],

        06.50: [
            Pitch.Spelling(.g, .quarter, .flat(count: 1)),
            Pitch.Spelling(.f, .threeQuarter, .sharp(count: 1))
        ],

        06.75: [
            Pitch.Spelling(.g, .natural, .down),
            Pitch.Spelling(.g, .quarter, .flat(count: 1), .up),
        ...
        07.00: [
            ...
            Pitch.Spelling(.a, .flat(count: 1))
        ],

        07.25: [
            Pitch.Spelling(.g, .natural, .up),
            Pitch.Spelling(.g, .quarter, .sharp(count: 1), .down),
            Pitch.Spelling(.a, .threeQuarter, .flat(count: 1), .down)
        ],

        07.50: [
            Pitch.Spelling(.g, .quarter, .sharp(count: 1)),
            Pitch.Spelling(.a, .threeQuarter, .flat(count: 1))
        ],

        07.75: [
            Pitch.Spelling(.g, .sharp(count: 1), .down),
            Pitch.Spelling(.a, .flat(count: 1), .down),
            Pitch.Spelling(.g, .quarter, .sharp(count: 1), .up),
            Pitch.Spelling(.a, .threeQuarter, .flat(count: 1), .up),
        ],
        ...
        08.25: [
            ...
            Pitch.Spelling(.a, .flat(count: 1), .up),
            Pitch.Spelling(.a, .quarter, .flat(count: 1), .down),
            Pitch.Spelling(.g, .threeQuarter, .sharp(count: 1), .down)
        ],

        08.50: [
            Pitch.Spelling(.a, .quarter, .flat(count: 1)),
            Pitch.Spelling(.g, .threeQuarter, .sharp(count: 1))
        ],

        08.75: [
            Pitch.Spelling(.a, .natural, .down),
            Pitch.Spelling(.a, .quarter, .flat(count: 1), .up),
            Pitch.Spelling(.g, .threeQuarter, .sharp(count: 1), .up)
        ],
        ...
        09.00: [
            ...
            Pitch.Spelling(.b, .flat(count: 1))
        ],

        09.25: [
            Pitch.Spelling(.a, .natural, .up),
            Pitch.Spelling(.a, .quarter, .sharp(count: 1), .down),
            Pitch.Spelling(.b, .threeQuarter, .flat(count: 1), .down)
        ],
        ...
        09.75: [
            Pitch.Spelling(.b, .flat(count: 1), .down),
            Pitch.Spelling(.a, .sharp(count: 1), .down),
            Pitch.Spelling(.b, .threeQuarter, .flat(count: 1), .up),
        ...
        10.00: [
            ...
            Pitch.Spelling(.c, .flat(count: 1))
        ],

        10.25: [
            Pitch.Spelling(.b, .flat(count: 1), .up),
            Pitch.Spelling(.a, .sharp(count: 1), .up),
            Pitch.Spelling(.b, .quarter, .flat(count: 1), .down),
            Pitch.Spelling(.a, .threeQuarter, .sharp(count: 1), .down)
        ],

        10.50: [
            Pitch.Spelling(.b, .quarter, .flat(count: 1)),
            Pitch.Spelling(.a, .threeQuarter, .sharp(count: 1))
        ],

        10.75: [
            Pitch.Spelling(.b, .natural, .down),
            Pitch.Spelling(.b, .quarter, .flat(count: 1), .up),
        ...
        11.25: [
            ...
            Pitch.Spelling(.c, .quarter, .flat(count: 1), .down)
        ],

        11.50: [
            Pitch.Spelling(.b, .quarter, .sharp(count: 1)),
            Pitch.Spelling(.c, .quarter, .flat(count: 1))
        ],

        11.75: [
            Pitch.Spelling(.c, .natural, .down),
            Pitch.Spelling(.b, .quarter, .sharp(count: 1), .up),
            Pitch.Spelling(.c, .quarter, .flat(count: 1), .up),
        ]
    ]
